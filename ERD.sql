...
ALTER TABLE `product_price_history` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);

ALTER TABLE `product_price_history` ADD FOREIGN KEY (`changed_by`) REFERENCES `users` (`id`);

ALTER TABLE `products` ADD FOREIGN KEY (`id`) REFERENCES `storage_inventory` (`product_id`);

ALTER TABLE `storage_transactions` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);

ALTER TABLE `storage_transactions` ADD FOREIGN KEY (`created_by`) REFERENCES `users` (`id`);

ALTER TABLE `shifts` ADD FOREIGN KEY (`shift_template_id`) REFERENCES `shift_templates` (`id`);

ALTER TABLE `shifts` ADD FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`);

ALTER TABLE `shift_staff` ADD FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`id`);

ALTER TABLE `shift_staff` ADD FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);

ALTER TABLE `shift_inventory` ADD FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`id`);

ALTER TABLE `shift_inventory` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);

ALTER TABLE `shift_stock_additions` ADD FOREIGN KEY (`shift_id`) REFERENCES `shifts` (`id`);

ALTER TABLE `shift_stock_additions` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);

ALTER TABLE `shift_stock_additions` ADD FOREIGN KEY (`added_by`) REFERENCES `users` (`id`);

ALTER TABLE `shift_handovers` ADD FOREIGN KEY (`from_shift_id`) REFERENCES `shifts` (`id`);

ALTER TABLE `shift_handovers` ADD FOREIGN KEY (`to_shift_id`) REFERENCES `shifts` (`id`);

ALTER TABLE `shift_handovers` ADD FOREIGN KEY (`handed_by`) REFERENCES `users` (`id`);

ALTER TABLE `shift_handovers` ADD FOREIGN KEY (`received_by`) REFERENCES `users` (`id`);

ALTER TABLE `shift_handover_details` ADD FOREIGN KEY (`handover_id`) REFERENCES `shift_handovers` (`id`);

ALTER TABLE `shift_handover_details` ADD FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
